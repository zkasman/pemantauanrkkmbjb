"""
Django settings for pemantauanrkkmbjb project.
...
INSTALLED_APPS = [
    ...
    #local apps
    'projekrkk.apps.ProjekrkkConfig',
]
...
ROOT_URLCONF = 'pemantauanrkkmbjb.urls'
...
WSGI_APPLICATION = 'pemantauanrkkmbjb.wsgi.application'
